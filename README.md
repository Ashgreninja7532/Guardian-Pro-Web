...
*   **Intruder Selfie:** Captures photo of unauthorized access attempts.
*   **Uninstall Protection:** Prevents app removal without PIN.
*   **Smart Re-Lock:** Custom delay settings.
